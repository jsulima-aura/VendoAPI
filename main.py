...
prod_suma AS (
    ...
    FROM dok_produkt dp
    CROSS JOIN cfg c
    GROUP BY dp.ttw_idtowaru, dp.produkt_kod, dp.produkt_nazwa, dp.ean, dp.grupa_i, dp.segment_klienta
),
stan_mag AS (
    SELECT
        p.ttw_idtowaru,
...
"""
CSV_HEADERS = (
    "Kod", "Nazwa", "EAN", "Grupa I", "Segment klienta", "Brutto (*)", "Sprzedaz netto [PLN]",
